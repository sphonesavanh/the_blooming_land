...
const About: React.FC = () => {
  return (
    <div className="font-serif p-8 min-h-screen max-w-full bg-[#f9f6e6]">
      <h1 className="">THE BLOOMING LAND,</h1>
      <h2 className="mt-3">
      ...
      <h2>
        ...
        <br />
        individuals who strive to succeed in life. Yet, life doesn't unfold the
        <br />
      ...
      <img
        src={aboutPic}
        alt="about page pic"
        className="mt-8 max-w-full w-full h-50"
      />
      <Link
        to="/content"
